...
class Parameters:
    ...
    anomalous_job_len_upper_bound = 29
    anomalous_job_len_lower_bound = 19
    anomalous_job_len_middle_bound = 23
    def __init__(self):

        self.output_filename = 'data/tmp'

        self.num_epochs = 3001              # number of training epochs
        ...
        self.max_job_len = 18               # maximum duration of new jobs
        
        self.res_slot = 15                  # maximum number of available resource slots
        self.res_slot1 = 10
        self.res_slot2 = 10
        self.res_slot3 = 15
        ...
        self.anomalous_job_len_upper_bound = 29
        self.anomalous_job_len_lower_bound = 19
        self.anomalous_job_len_middle_bound = 23
