...
class Parameters:
    ...
    def __init__(self):
        ...
        self.network_input_width = \
            (self.res_slot +
             self.anomalous_job_resources_upper * self.num_nw*2) * self.num_res + \
            self.backlog_width + \
        ...
        self.network_output_dim = self.num_nw * 4 + 1#self.num_nw + 2  # + 1 for void action +2 for remove action
        ...
        self.removed_penality = -1
        self.destroy_penality = -1
    ...
    def compute_dependent_parameters(self):
        ...
        self.network_output_dim = self.num_nw * 4 + 1 # + 1 for void action
